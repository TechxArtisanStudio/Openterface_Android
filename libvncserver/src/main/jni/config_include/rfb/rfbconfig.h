/*
 * rfb/rfbconfig.h — Android NDK configuration for LibVNCServer
 *
 * Hand-crafted for Android/bionic. This lives in the parent repo (not the
 * libvnc submodule) because upstream .gitignore excludes rfbconfig.h
 * (it is normally generated by CMake/autoconf).
 */

#ifndef _RFB_RFBCONFIG_H
#define _RFB_RFBCONFIG_H

/* rfb/rfbconfig.h.  Generated manually for Android NDK build.  */
