...
/**
 * Integration test for VncServerService foreground service behavior.
 * Tests the fix for SecurityException when starting foreground service on Android 14+.
 */
@RunWith(AndroidJUnit4.class)
public class VncServerServiceIntegrationTest {
    ...
    public void tearDown() {
        ...
        Intent stopIntent = new Intent(context, VncServerService.class);
        context.stopService(stopIntent);
    }

    /**
     * Test that VncServerService can be started without throwing SecurityException.
    ...
    public void testServiceStartsWithoutException() {
        // Start the service
        Intent startIntent = new Intent(context, VncServerService.class);
